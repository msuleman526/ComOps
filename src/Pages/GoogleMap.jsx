...
import {
  ...
  setApparatusLbl,
  setAreaLblMarker,
  setUpApparatusMarker,
  setUpAreaDrawingManager,
  setUpHazardMarker,
...
const GoogleMap = () => {
  ...
  const handleMapClick = ({ lat, lng }) => {
    if (apparatusDrawingEnabled && selectedApparatus != null) {
      ...
      currentApparatusMarker = setUpApparatusMarker(
        googleMaps,
        lat,
        lng,
        55,
      ...
      let marker = setUpHazardMarker(
        googleMaps,
        lat,
        lng,
        selectedHazard.width,
        selectedHazard.height,
        true,
  ...
  let onApparatusLblChange = (val) => {
    ...
    var labelMarker = setApparatusLbl(
      googleMaps,
      googleMap,
      true,
      currentLat,
  ...
  return (
    ...
    >
      ...
      <ApparatusPopup
        isOpen={isApparatusModalOpen}
        setIsOpen={setApparatusModalOpen}
        selectApparatus={onChangeAppratusModal}
      />
      <HazardsPopup
        isOpen={isHazardModalOpen}
        setIsOpen={setIsHazardModelOpen}
        selectedHazard={onChangeHazardModal}
      />
      <AppratusLblPopup
        isOpen={showAppratusLblPopup}
        setIsOpen={setShowAppratusLblPopup}
        currentApparatus={selectedApparatus?.name}
        setApparatusLabel={onApparatusLblChange}
      />
      <AreaPopup
        isOpen={isAreaPopupOpen}
        setIsOpen={setIsAreaPopupOpen}
        chooseArea={onAreaTypeClick}
      />
    </div>
  );
};
